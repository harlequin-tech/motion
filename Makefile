...
# install.                                                                     #
################################################################################
CFLAGS       =  -march=armv6zk -mcpu=arm1176jzf-s -mtune=arm1176jzf-s -mfpu=vfp -mfloat-abi=hard -D_REENTRANT -DHAVE_FFMPEG -I/usr/include -DFFMPEG_NEW_INCLUDES -DHAVE_FFMPEG_NEW -I/usr/include/mysql -I/usr/include/postgresql -DMOTION_V4L2 -DMOTION_V4L2_OLD -DTYPE_32BIT="int" -DHAVE_BSWAP    -Wall -DVERSION=\"Git-8619d7c17ce112e7196975905c6e840f345141ba\" -Dsysconfdir=\"$(sysconfdir)\" 
CFLAGS += -I/opt/vc/include -I/opt/vc/include/interface/vcos/pthreads -I/opt/vc/include/interface/vmcs_host/linux
CFLAGS += -std=gnu99
LDFLAGS      =   -L/usr/lib/arm-linux-gnueabihf -L/opt/vc/lib
LIBS         = -lm  -lpthread -ljpeg -L/usr/lib/arm-linux-gnueabihf -lavformat -lavcodec -lavutil -lm -lz -lsqlite3 -L/usr/lib/arm-linux-gnueabihf -lmysqlclient -lz -L/usr/lib -lpq \
	       -lmmal -lmmal_core -lmmal_util -lmmal_vc_client -lvchostif
VIDEO_OBJ    = video.o video2.o video_common.o
COBJ          = motion.o logger.o conf.o draw.o jpegutils.o vloopback_motion.o $(VIDEO_OBJ) \
			   netcam.o netcam_ftp.o netcam_jpeg.o netcam_wget.o track.o \
			   alg.o event.o picture.o rotate.o webhttpd.o \
			   stream.o md5.o ffmpeg.o videosourceplugin.o filecam.o mmalcam.o \
			   RaspiCamControl.o RaspiCLI.o utils.o metrics.o
CSRC         = $(COBJ:.o=.c)
OBJ          = $(COBJ) alg_arm.o
SRC          = $(CSRC) alg_arm.s
